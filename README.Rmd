...
Using a simulated voting data (long-format dataframe) `m_data_dyn` and a simulated matching bill data for dynamic estimation (See more detail of across time estimation in Bailey (2007)).
